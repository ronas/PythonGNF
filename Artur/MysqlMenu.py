...
# Codigo  Nome  UnidadeMedida  Peso  CodigoEAN CodigoMoeda  PrecoCompra  ValorVenda      
    ...
    varunidademedida = input("digitar UnidadeMedida: ")
    varpeso = input("digitar peso: ")
    varcodigoean = input("digitar CodigoEAN: ")
    varcodigomoeda = input("digitar CodigoMoeda: ")
    varprecocompra = input("digitar PrecoCompra: ")
    varvalorvenda = input("digitar ValorVenda: ")
    dados = (varcodigo,
             varnome,
             varunidademedida,
             varpeso,
